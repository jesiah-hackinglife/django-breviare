...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Link.link_short'
        db.alter_column('breviare_urls_link', 'link_short', self.gf('django.db.models.fields.URLField')(default=datetime.datetime(2012, 4, 17, 0, 0), max_length=500))
    models = {
        'breviare_urls.click': {
        ...
        'breviare_urls.link': {
            ...
            'link_short': ('django.db.models.fields.URLField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'})
        }
    }
